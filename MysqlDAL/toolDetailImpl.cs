...
{
    /// <summary>
    /// 数据访问类:tooldetailImpl
    /// </summary>
    public partial class tooldetailImpl : ItoolDetail
    {
        ...
        public int Add(Model.toolDetail model)
        {
            ...
            strSql.Append("todeId,toolId,toolPara,toolParaValue,isDelete)");
            strSql.Append(" values (");
            strSql.Append("@todeId,@toolId,@toolPara,@toolParaValue,@isDelete)");
            MySqlParameter[] parameters = {
					new MySqlParameter("@todeId", MySqlDbType.Int32,11),
					new MySqlParameter("@toolId", MySqlDbType.Int32,11),
					new MySqlParameter("@toolPara", MySqlDbType.VarChar,40),
					new MySqlParameter("@toolParaValue", MySqlDbType.VarChar,40),
					new MySqlParameter("@isDelete", MySqlDbType.Int32,11)};
            parameters[0].Value = model.todeId;
            parameters[1].Value = model.toolId;
            parameters[2].Value = model.toolPara;
            parameters[3].Value = model.toolParaValue;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select todeId,toolId,toolPara,toolParaValue,isDelete from tooldetail ");
